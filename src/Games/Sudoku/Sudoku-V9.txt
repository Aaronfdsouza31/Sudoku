...
export default function Sudoku() {
  ...
  useEffect(() => {
    if (stage === "play") timerRef.current = setInterval(() => setTimer(t => t + 1), 1000);
    ...
    <div style={st.wrap}>
      {stage === "name" ? (
        ...
        <>
                  ...
                  return (
                    <div
                      ...
                      style={{
                        ...
                        fontWeight: clue || isMatch ? "bold" : "normal",
                        position: "relative",
                        ...
                        [...notes[r][c]].length > 0 && (
                          <div style={st.notesBox}>
                            {[1,2,3,4,5,6,7,8,9].map(n => (
                              <span key={n} style={{ fontSize: 10, opacity: notes[r][c].has(String(n)) ? 1 : 0 }}>
                                {n}
                              </span>
                            ))}
                          </div>
          ...
          <button onClick={() => setPencil(p => !p)} style={{ marginTop: 10 }}>
